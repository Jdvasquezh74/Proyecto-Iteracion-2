...
//			e.printStackTrace();
    	...
    	try
		{
			...
			VOUsuario tipoBebida1 = parranderos.adicionarTipoBebida (nombreTipoBebida1);
			lista = parranderos.darVOUsuarios();
			...
			VOUsuario tipoBebida2 = parranderos.adicionarTipoBebida (nombreTipoBebida2);
			lista = parranderos.darVOUsuarios();
			...
			// Prueba de eliminación de un tipo de bebida, dado su identificador
			tbEliminados = parranderos.eliminarUsuarioPorIdentificacion (nombreTipoBebida2);
			assertEquals ("Debe haberse eliminado un tipo de bebida !!", 1, tbEliminados);
			lista = parranderos.darVOUsuarios();
...
//			e.printStackTrace();
		...
		try
		{
			...
			VOUsuario tipoBebida2 = parranderos.adicionarTipoBebida (nombreTipoBebida1);
